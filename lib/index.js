...
var ConnectionDetailsService_service_1 = require("./services/ConnectionDetailsService.service");
...
if (argv.c) {
    var logStreamer = new ConnectionDetailsService_service_1.ConnectionDetailsService(argv.f);
    logStreamer.stream();
}
